...
### Contract
NFTMarketplace : contracts/npc_marketplace/npc_marketplace.sol
...
inherits MarketplaceBidding:
### placeBid

```solidity
function placeBid(uint256 listingId) public payable virtual
```

### acceptBid

```solidity
function acceptBid(uint256 listingId) public virtual
```

inherits MarketplaceCore:
### setListingFee
...
```solidity
event BidWithdrawn(uint256 listingId, address bidder, uint256 amount)
```

### BidAccepted

```solidity
event BidAccepted(uint256 listingId, address seller, address bidder, uint256 amount)
```
...
### Contract
MarketplaceBidding : contracts/npc_marketplace/npc_marketplace_bidding.sol
